...
export declare class NgxTimepickerDirective implements ControlValueAccessor, OnInit, AfterViewInit, OnDestroy {
    private cRef;
    private eRef;
    private Service;
    ...
    static ɵdir: i0.ɵɵDirectiveDeclaration<NgxTimepickerDirective, "[timepicker]", never, { "format": "format"; }, {}, never>;
}
