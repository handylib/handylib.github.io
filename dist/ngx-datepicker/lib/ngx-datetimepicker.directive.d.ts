...
export declare class NgxDatetimepickerDirective implements ControlValueAccessor, OnInit, AfterViewInit, OnDestroy {
    private cRef;
    private eRef;
    private Service;
    ...
    static ɵdir: i0.ɵɵDirectiveDeclaration<NgxDatetimepickerDirective, "[datetimepicker]", never, { "format": "format"; }, {}, never>;
}
