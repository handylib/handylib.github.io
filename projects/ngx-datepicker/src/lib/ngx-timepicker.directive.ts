...
export class NgxTimepickerDirective implements ControlValueAccessor, OnInit, AfterViewInit, OnDestroy {
  ...
  ngAfterViewInit(): void {
    ...
    this.component.instance.config.mode = "time";
  ...
  @Input("format") format: string = "HH:mm:ss";
